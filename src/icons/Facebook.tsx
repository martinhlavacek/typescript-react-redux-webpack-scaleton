...
export default function Facebook() {
    return (
        <svg className="icon icon-facebook" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0" y="0" viewBox="0 0 90 90" enableBackground="new 0 0 90 90" xmlSpace="preserve">
            <g>
